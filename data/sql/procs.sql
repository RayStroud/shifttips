...
DROP PROCEDURE IF EXISTS getSummaryByLocation;
	DELIMITER //
	CREATE PROCEDURE getSummaryByLocation (p_user_id INT, p_dateFrom DATE, p_dateTo DATE)
	BEGIN
		-- VARCHAR(11) is highest int value, which is what a user_id can be
		DECLARE v_user_id		VARCHAR(11);
		DECLARE v_dateFrom		DATE;
